  ...
  return (
    <group position={position} rotation={[Math.PI / 2, 0, 0]}>
      ...
      {Array.from({ length: 12 }).map((_, i) => {
        ...
        const r = 0.14;
        return (
          <mesh key={i} position={[Math.sin(angle) * r, 0.038, Math.cos(angle) * r]} rotation={[0, angle, 0]}>
            <boxGeometry args={[0.012, 0.006, i % 3 === 0 ? 0.03 : 0.02]} />
      ...
      <group ref={hourRef} position={[0, 0.042, 0]}>
        <mesh position={[0, 0, -0.045]}>
          <boxGeometry args={[0.014, 0.007, 0.09]} />
      ...
      <group ref={secondRef} position={[0, 0.05, 0]}>
        <mesh position={[0, 0, -0.08]}>
          <boxGeometry args={[0.004, 0.004, 0.16]} />
